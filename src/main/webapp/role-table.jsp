                                                                ...
                                                                <form id="myform">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control roleName-value" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Role Name" required>
                                                                                <%--                                                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--%>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="exampleInputPassword1">Description</label>
                                                                            <input type="text" class="form-control desc-value" id="exampleInputPassword1" placeholder="Description" required="true">
                                                                        </div>
                                                                    </div>
