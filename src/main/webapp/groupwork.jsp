                        ...
                        <div class="white-box">
                            <div class="table-responsive">
                                <table class="table" id="example">
                                    ...
                                    <tr>
                                        <td id="job_id">${jobslist.getId()}</td>
                                        <td>${jobslist.getJobName()}</td>
                                        <td>${jobslist.getStartDate()}</td>
                                        <td>${jobslist.getEndDate()}</td>
                                                    ...
                                                    <form id="myform">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control jobname-value" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Job Name" required>
                                                                    <%--                                                                        <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>--%>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">START DATE</label>
                                                                <input type="text" class="form-control startdate-value" id="exampleInputPassword1" placeholder="Enter Start Date" required="true">
                                                                <small class="form-text text-muted">Please fullfill with the right format: "YYYY-MM-DD"</small>

                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">END DATE</label>
                                                                <input type="text" class="form-control enddate-value" id="exampleInputPassword2" placeholder="Enter End Date" required="true">
                                                                <small class="form-text text-muted">Please fullfill with the right format: "YYYY-MM-DD"</small>
                                        ...
                                        <td>
                                        <a href="#" jobId="${jobslist.getId()}" class="btn btn-sm btn-primary btn-update">Sửa</a>
                                        <a href="#" jobId="${jobslist.getId()}" class="btn btn-sm btn-danger btn-delete">Xóa</a>
